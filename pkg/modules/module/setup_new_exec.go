...
func init() {
	...
	m.RegisterOnceTable("setup_new_exec_events", modules.RenderHandler(setupNewExecEvent{}, nil))
	m.RegisterOnceTable("setup_new_exec_ret_events", modules.RenderHandler(setupNewExecRetEvent{}, nil))
	factory.Register(m)
}
