...
// CheckEnv check program run env
func CheckEnv() {
    for _, envChecker := range envCheckers {
        envChecker()
    }
}

type checkerList []func()

var envCheckers = checkerList{}

func register(c func()) {
    envCheckers = append(envCheckers, c)
}
...
`)
    ...
    register(func() {
        log.Printf("\033[1mThe program depend on bcc, please make sure you had install bcc, " +
            "for more information, see %q\033[0m\n", "https://github.com/iovisor/bcc/blob/master/INSTALL.md")
